...
function gocdRequestorModule() {
  ...
  var getPipelineDetails = function(pipelineId, pipelineName) {
    var pipelineDetailsPath = baseUrl() + getGocdPipelineBasePath(pipelineName) + '/' + pipelineId + '.xml';
  ...
  var getHistory = function(offset, pipelineName) {
    ...
    var historyPagePath = baseUrl() + getGocdHistoryPath(pipelineName) + (offset ? '/' + offset : '');
